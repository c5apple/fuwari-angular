...
import * as import15 from './articles/top.component';
import * as import16 from './articles/what-is-angular.component';
import * as import17 from './articles/eco-system.component';
...
import * as import21 from '@angular/core/src/linker/ng_module_factory_loader';
...
class AppRoutingModuleInjector extends import0.NgModuleInjector<import1.AppRoutingModule> {
  ...
  get _ROUTES_9():any[] {
      if ((this.__ROUTES_9 == null)) { (this.__ROUTES_9 = [[
        {
          path: '',
          component: import15.TopComponent
        }
        ,
        {
          path: 'top',
  ...
  get _Router_10():any {
    if ((this.__Router_10 == null)) { (this.__Router_10 = import2.setupRouter(this.parent.get(import18.ApplicationRef),this._UrlSerializer_6,this._RouterOutletMap_7,this._Location_5,this,this._NgModuleFactoryLoader_8,this.parent.get(import14.Compiler),this._ROUTES_9,this._ROUTER_CONFIGURATION_3,this.parent.get(import19.UrlHandlingStrategy,(null as any)))); }
  ...
  get _ROUTER_INITIALIZER_16():any {
    if ((this.__ROUTER_INITIALIZER_16 == null)) { (this.__ROUTER_INITIALIZER_16 = import2.initialRouterNavigation(this._Router_10,this.parent.get(import18.ApplicationRef),this._RouterPreloader_14,this._ROUTER_CONFIGURATION_3)); }
  ...
  createInternal():import1.AppRoutingModule {
    this._ROUTER_FORROOT_GUARD_0 = import2.provideForRootGuard(this.parent.get(import20.Router,(null as any)));
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import21.NgModuleFactoryLoader)) { return this._NgModuleFactoryLoader_8; }
    if ((token === import22.ROUTES)) { return this._ROUTES_9; }
    if ((token === import20.Router)) { return this._Router_10; }
    if ((token === import23.ActivatedRoute)) { return this._ActivatedRoute_11; }
    ...
    if ((token === import24.APP_BOOTSTRAP_LISTENER)) { return this._APP_BOOTSTRAP_LISTENER_17; }
