...
import * as import9 from './top/top.component.ngfactory';
...
import * as import13 from './top/top.component';
...
import * as import17 from '@angular/core/src/linker/ng_module_factory_loader';
...
class AppRoutingModuleInjector extends import0.NgModuleInjector<import1.AppRoutingModule> {
  ...
  constructor(parent:import8.Injector) {
    super(parent,[import9.TopComponentNgFactory],([] as any[]));
  }
  ...
  get _Router_10():any {
    if ((this.__Router_10 == null)) { (this.__Router_10 = import2.setupRouter(this.parent.get(import14.ApplicationRef),this._UrlSerializer_6,this._RouterOutletMap_7,this._Location_5,this,this._NgModuleFactoryLoader_8,this.parent.get(import12.Compiler),this._ROUTES_9,this._ROUTER_CONFIGURATION_3,this.parent.get(import15.UrlHandlingStrategy,(null as any)))); }
  ...
  get _ROUTER_INITIALIZER_16():any {
    if ((this.__ROUTER_INITIALIZER_16 == null)) { (this.__ROUTER_INITIALIZER_16 = import2.initialRouterNavigation(this._Router_10,this.parent.get(import14.ApplicationRef),this._RouterPreloader_14,this._ROUTER_CONFIGURATION_3)); }
  ...
  createInternal():import1.AppRoutingModule {
    this._ROUTER_FORROOT_GUARD_0 = import2.provideForRootGuard(this.parent.get(import16.Router,(null as any)));
  ...
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import17.NgModuleFactoryLoader)) { return this._NgModuleFactoryLoader_8; }
    if ((token === import18.ROUTES)) { return this._ROUTES_9; }
    if ((token === import16.Router)) { return this._Router_10; }
    if ((token === import19.ActivatedRoute)) { return this._ActivatedRoute_11; }
    ...
    if ((token === import20.APP_BOOTSTRAP_LISTENER)) { return this._APP_BOOTSTRAP_LISTENER_17; }
